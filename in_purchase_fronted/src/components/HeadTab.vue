<template>
  <a-page-header style="padding: 0">
    <a-row justify="center" :wrap="false" align="middle">
      ...
      <a-col :span="1"><span @click="login()" style="cursor: pointer; color: #f582ae">
        <Icon icon="iconamoon:profile-light" width="35px"></Icon>
        {{user}}
      </span></a-col>
      <a-col :span="5"></a-col>
    </a-row>
    ...
    ">
        ...
        <a-col :span="3"
               ...
               border-top-left-radius: 5px;
                ...
                "
        >
               <Icon icon="material-symbols:list-rounded" style="float:left;" width="30px" color="white"></Icon>
                所有类目
        </a-col>
      <a-col :span="1"></a-col>
